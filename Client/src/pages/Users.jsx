...
const Users = () => {
  ...
  TableRow.propTypes = {
    user: PropTypes.shape({
      name: PropTypes.string.isRequired, // Full name is required
      title: PropTypes.string.isRequired, // Title is required
      email: PropTypes.string, // Email is optional
      role: PropTypes.string.isRequired, // Role is required
      isActive: PropTypes.bool.isRequired, // Active status is required
      _id: PropTypes.string.isRequired, // User ID is required
    }).isRequired,
  };
